...
class _NotesWidget extends State<NotesWidgets> with SingleTickerProviderStateMixin {
      ...
      if (subjectsResponse.statusCode == 200) {
        ...
        for (var subject in subjects) {
          ...
          final notesResponse = await http.get(
            Uri.parse('$baseurl/mobile/notes/get-by-course-subject/$courseId/$subjectId/$token'),
          );
        ...
        setState(() {
          errorMessage = 'Failed to fetch subjects: ${subjectsResponse.statusCode}';
          isLoading = false;
        });
      }
    } catch (e) {
